...
class Iterators:
    ...
    def createIterator(self):
        ...
        :return:
        """
        assert isinstance(self.data, list), "ERROR:data must be in list[tarin_data,dev_data]"
    ...
    @staticmethod
    def _convert_word2id(insts, operator):  # operator 是传进来的alphabet
        """
    ...
    def _Create_Each_Batch(self, insts, batch_size, operator):
        ...
        features.inst = insts  # insts是一个batch
